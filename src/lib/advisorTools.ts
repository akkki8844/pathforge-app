...
export const IN_APP_ROUTES: readonly AppRoute[] = [
  ...
  { path: "/professors", label: "Professors", purpose: "Recommenders, requests and LOR strategy" },
  ...
  { path: "/routine/calendar", label: "Calendar", purpose: "Every class, deadline, study block and test date on one grid" },
