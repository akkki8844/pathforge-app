...
export const competitionCalendar: CompetitionWindow[] = [
  // ── CS / Math Competitions ──
  {
    ...
    registrationOpen: "2026-11-01",
    registrationClose: "2026-12-15",
    competitionStart: "2026-12-13",
    competitionEnd: "2027-03-28",
  ...
  },
  {
    ...
    registrationOpen: "2026-09-01",
    registrationClose: "2026-10-15",
    competitionStart: "2026-11-06",
    competitionEnd: "2026-11-12",
  ...
  },
  {
    ...
    category: "Mathematics",
    competitionStart: "2027-02-05",
    competitionEnd: "2027-02-13",
  ...
  },
  {
    ...
    name: "Math Kangaroo",
    category: "Mathematics",
    registrationOpen: "2026-09-15",
    registrationClose: "2027-03-01",
    competitionStart: "2027-03-19",
    competitionEnd: "2027-03-19",
  ...
  },
  {
    ...
    category: "Mathematics",
    competitionStart: "2027-07-10",
    competitionEnd: "2027-07-20",
  ...
  // ── Science Olympiads ──
  {
    ...
    registrationClose: "2026-10-15",
    competitionStart: "2027-01-15",
    competitionEnd: "2027-05-31",
  ...
  },
  {
    ...
    category: "Chemistry",
    competitionStart: "2027-07-18",
    competitionEnd: "2027-07-27",
  ...
  },
  {
    ...
    category: "Biology",
    competitionStart: "2027-07-05",
    competitionEnd: "2027-07-13",
  ...
  },
  {
    ...
    category: "Humanities",
    registrationOpen: "2027-01-01",
    registrationClose: "2027-06-30",
    resultDate: "2027-09-15",
  ...
  // ── Economics / Business ──
  {
    ...
    category: "Business",
    registrationOpen: "2026-09-01",
    registrationClose: "2026-11-30",
    competitionStart: "2027-01-15",
    competitionEnd: "2027-04-30",
  ...
  },
  {
    ...
    category: "Business",
    registrationOpen: "2026-09-01",
    registrationClose: "2026-12-01",
    competitionStart: "2027-02-01",
    competitionEnd: "2027-06-30",
  ...
  // ── India-Specific ──
  {
    ...
    competitionStart: "2026-09-14",
    competitionEnd: "2026-09-14",
  ...
  },
  {
    ...
    registrationClose: "2026-10-15",
    competitionStart: "2026-11-24",
    competitionEnd: "2026-11-24",
  ...
  },
  {
    ...
    registrationOpen: "2026-07-01",
    registrationClose: "2026-08-31",
    competitionStart: "2026-11-01",
    competitionEnd: "2026-11-01",
  ...
  // ── UK-Specific ──
  {
    ...
    category: "Mathematics",
    competitionStart: "2026-10-01",
    competitionEnd: "2027-06-15",
  ...
  },
  {
    ...
    category: "Physics",
    registrationOpen: "2026-09-01",
    registrationClose: "2026-10-31",
    competitionStart: "2026-11-08",
    competitionEnd: "2026-11-08",
  ...
  // ── Research Programs ──
  {
    ...
    category: "Research",
    registrationOpen: "2026-11-01",
    registrationClose: "2027-01-15",
    competitionStart: "2027-06-22",
    competitionEnd: "2027-08-01",
  ...
  },
  {
    ...
    category: "Research",
    registrationOpen: "2026-11-15",
    registrationClose: "2027-02-07",
    competitionStart: "2027-06-15",
    competitionEnd: "2027-07-31",
  ...
  },
  {
    ...
    category: "Research",
    competitionStart: "2027-05-10",
    competitionEnd: "2027-05-15",
  ...
  // ── Debate / Model UN ──
  {
    ...
    registrationOpen: "2026-09-01",
    registrationClose: "2027-03-01",
    competitionStart: "2027-06-14",
    competitionEnd: "2027-06-19",
...
export function getCompetitionStatusInfo(comp: CompetitionWindow): CompetitionStatusInfo {
  ...
  // Past — build reopen info. If the named reopen month hasn't happened yet
  // this calendar year, the next window is this year; otherwise next year.
  const reopenMonth = comp.expectedReopenMonth;
  const monthIndex = reopenMonth
    ? ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"].indexOf(reopenMonth)
    : -1;
  const nowDate = new Date();
  const reopenYear = monthIndex >= 0 && monthIndex >= nowDate.getMonth()
    ? nowDate.getFullYear()
    : nowDate.getFullYear() + 1;
  const reopenInfo = reopenMonth
    ? `Expected to reopen around ${reopenMonth} ${reopenYear}`
    : comp.recurring
