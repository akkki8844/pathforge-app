...
function BulletList({ items, icon: Icon, tone = "text-primary" }: { items?: string[]; icon?: any; tone?: string }) {
...
function ReportView({ report }: { report: RequirementsReport }) {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="overflow-hidden shadow-none hover:shadow-none border-primary/30 bg-gradient-to-br from-primary/5 via-card to-card">
      ...
      <Tabs defaultValue="fit" className="w-full">
        ...
        <TabsContent value="academics" className="mt-5 space-y-5">
          <div className="grid md:grid-cols-2 gap-5">
            <Card className="shadow-none hover:shadow-none">
              <CardHeader className="pb-3">
                <CardTitle className="text-sm flex items-center gap-2"><BookOpen className="h-4 w-4 text-primary" /> Academic bar</CardTitle>
              </CardHeader>
              <CardContent>
                ...
                {report.academics.studentStanding && (
                  <div className="mt-4 rounded-md border border-primary/30 bg-primary/5 p-3">
                    <div className="text-[10px] uppercase tracking-wide text-primary mb-1">Where you stand</div>
            ...
            <Card className="shadow-none hover:shadow-none">
              <CardHeader className="pb-3">
                <CardTitle className="text-sm flex items-center gap-2"><Target className="h-4 w-4 text-primary" /> Testing</CardTitle>
              </CardHeader>
              <CardContent>
        ...
        <TabsContent value="profile" className="mt-5 space-y-5">
          {(() => {
            ...
            return items.length > 0 ? (
              <Card className="shadow-none hover:shadow-none">
                <CardHeader className="pb-3">
                  <CardTitle className="text-sm flex items-center gap-2"><GraduationCap className="h-4 w-4 text-primary" /> Major-specific requirements</CardTitle>
                </CardHeader>
          ...
          <div className="grid md:grid-cols-2 gap-5">
            <Card className="shadow-none hover:shadow-none">
              <CardHeader className="pb-3">
                <CardTitle className="text-sm flex items-center gap-2"><ListChecks className="h-4 w-4 text-primary" /> Qualities they seek</CardTitle>
              </CardHeader>
              <CardContent>
                {(() => {
                      ...
                      {qs.map((q: any, i: number) => (
                        <li key={i} className="flex gap-2 text-sm">
                          ...
                          <div>
                            ...
                            {q.studentEvidence && <div className="text-xs text-primary mt-0.5">You: {q.studentEvidence}</div>}
                          </div>
                        </li>
                      ))}
                    </ul>
            ...
            <Card className="shadow-none hover:shadow-none">
              <CardHeader className="pb-3">
                <CardTitle className="text-sm flex items-center gap-2"><Award className="h-4 w-4 text-primary" /> Extracurricular profile</CardTitle>
              </CardHeader>
              <CardContent className="space-y-3">
                ...
                {report.extracurriculars?.studentECReview && (
                  <div className="rounded-md border border-primary/30 bg-primary/5 p-3">
                    <div className="text-[10px] uppercase tracking-wide text-primary mb-1">Your EC review</div>
        ...
        <TabsContent value="application" className="mt-5 space-y-5">
          <div className="grid md:grid-cols-2 gap-5">
            <Card className="shadow-none hover:shadow-none">
              <CardHeader className="pb-3">
                <CardTitle className="text-sm flex items-center gap-2"><FileText className="h-4 w-4 text-primary" /> Essays & application</CardTitle>
              </CardHeader>
              <CardContent>
                ...
                {report.recommendations?.studentAdvice && (
                  <div className="mt-2 rounded-md border border-primary/30 bg-primary/5 p-3">
                    <div className="text-[10px] uppercase tracking-wide text-primary mb-1">Who you should ask</div>
                ...
                {report.interviews?.studentPrepNotes && (
                  <div className="mt-2 rounded-md border border-primary/30 bg-primary/5 p-3">
                    <div className="text-[10px] uppercase tracking-wide text-primary mb-1">Interview prep for you</div>
            ...
            <Card className="shadow-none hover:shadow-none">
              <CardHeader className="pb-3">
                <CardTitle className="text-sm flex items-center gap-2"><Calendar className="h-4 w-4 text-primary" /> Deadlines</CardTitle>
              </CardHeader>
              <CardContent>
                ...
                {report.deadlines?.recommendedRound && (
                  <div className="mt-4 rounded-md border border-primary/30 bg-primary/5 p-3">
                    <div className="text-[10px] uppercase tracking-wide text-primary mb-1">Recommended for you</div>
        ...
        <TabsContent value="money" className="mt-5 space-y-5">
          <Card className="shadow-none hover:shadow-none">
            <CardHeader className="pb-3">
              <CardTitle className="text-sm flex items-center gap-2"><DollarSign className="h-4 w-4 text-primary" /> Cost & financial aid</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              {report.financials?.notesForStudent && (
                <div className="rounded-md border border-primary/30 bg-primary/5 p-3">
                  <div className="text-[10px] uppercase tracking-wide text-primary mb-1">Notes for you</div>
          ...
          {report.outcomes && (
            <Card className="shadow-none hover:shadow-none">
              <CardHeader className="pb-3">
                <CardTitle className="text-sm flex items-center gap-2"><TrendingUp className="h-4 w-4 text-primary" /> Outcomes</CardTitle>
              </CardHeader>
              <CardContent className="space-y-2">
                ...
                {report.outcomes.relevanceForStudent && (
                  <div className="mt-2 rounded-md border border-primary/30 bg-primary/5 p-3">
                    <div className="text-[10px] uppercase tracking-wide text-primary mb-1">Why this matters for you</div>
        ...
        <TabsContent value="plan" className="mt-5 space-y-5">
          ...
          {(fa.blindSpots?.length > 0 || report.compareToSimilarSchools?.length > 0) && (
            <div className="grid md:grid-cols-2 gap-5">
              {fa.blindSpots?.length > 0 && (
                <Card className="shadow-none hover:shadow-none">
                  <CardHeader className="pb-3">
                    <CardTitle className="text-sm flex items-center gap-2"><Compass className="h-4 w-4 text-primary" /> Blind spots</CardTitle>
                  </CardHeader>
              ...
              {report.compareToSimilarSchools?.length > 0 && (
                <Card className="shadow-none hover:shadow-none">
                  <CardHeader className="pb-3">
                    <CardTitle className="text-sm flex items-center gap-2"><GraduationCap className="h-4 w-4 text-primary" /> Also evaluate</CardTitle>
                  </CardHeader>
          ...
          {report.twelveMonthRoadmap?.length > 0 && (
            <Card className="shadow-none hover:shadow-none">
              <CardHeader className="pb-3">
                <CardTitle className="text-sm flex items-center gap-2"><Map className="h-4 w-4 text-primary" /> 12-month roadmap</CardTitle>
              </CardHeader>
              <CardContent>
                <ol className="relative border-l-2 border-border space-y-5 pl-5">
                  {report.twelveMonthRoadmap.map((q: any, i: number) => (
                    <li key={i} className="relative">
                      <span className="absolute -left-[27px] top-1 h-4 w-4 rounded-full bg-primary border-4 border-card" />
                      <div className="text-xs uppercase tracking-wide text-primary font-semibold">{q.window}</div>
    ...
    <div data-cluely className="min-h-svh bg-background py-8 font-cluely sm:py-12">
      ...
      <div className="section-container max-w-7xl">
        <motion.div
          ...
          className="mb-8"
        >
          <Eyebrow>Admissions requirements</Eyebrow>
          ...
          <div className="grid lg:grid-cols-[280px_1fr] gap-6">
                  ...
                  {targets.map((c) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {isLoad && <Loader2 className="h-3.5 w-3.5 animate-spin text-primary" />}
                      </motion.button>
                    );
                  })}
                </motion.div>
            ...
            <div className="min-w-0">
              {tab === "history" ? (
                <Card className="shadow-none hover:shadow-none">
                  <CardHeader className="border-b border-border/60">
                    <CardTitle className="text-lg flex items-center gap-2">
                      <History className="h-5 w-5 text-primary" /> Saved reports
                    </CardTitle>
                  </CardHeader>
                    ...
                    {history.length === 0 ? (
                      ...
                      <ul className="space-y-2">
                        {history.map((h) => (
                          <li
                            key={h.id}
                            className="flex items-center gap-3 rounded-lg border border-border p-3 hover:border-primary/40 transition"
                          >
                            <CollegeLogo name={h.college} size={20} className="shrink-0" />
                            <div className="flex-1 min-w-0">
                ...
                <Card className="shadow-none hover:shadow-none border-border">
                  <CardHeader className="border-b border-border/60">
