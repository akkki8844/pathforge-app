...
export function NotFound({
  ...
  return (
    <div className="relative text-center z-[1] pt-52">
      ...
      <p className="mt-6 text-pretty text-lg font-medium text-slate-500 dark:text-slate-400 sm:text-xl/8">
        {description}
      </p>
      <div className="mt-10 flex flex-col sm:flex-row gap-y-3 sm:space-x-2 mx-auto sm:max-w-sm">
        <div className="relative w-full">
          ...
          <Input
            placeholder="Search"
            className="pl-8 border-blue-200 bg-white focus-visible:ring-blue-300 dark:border-blue-900 dark:bg-slate-950"
          />
        </div>
        <Button
          variant="outline"
      ...
      <div className="mt-10 flex flex-col sm:flex-row sm:items-center sm:justify-center gap-y-3 gap-x-6">
        ...
        <Button
          className="-order-1 sm:order-none bg-blue-700 text-white hover:bg-blue-800 dark:bg-blue-500 dark:hover:bg-blue-400"
          asChild
        >
